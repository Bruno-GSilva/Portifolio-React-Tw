...
import logo from "../assets/images/logo-bruno.png";
import "../styles.css";
...
function Navbar() {
  ...
  return (
    <>
      <div className="navbarcon flex justify-between items-center px-20 py-2 bg-transparent z-40 text-white lg:px-6 fixed w-full">
        <div className="flex items-center">
          <img className="w-16 mr-2" src={logo} alt="" />
          <h1 className="text-4xl  font-bold ">Bruno G.</h1>
        </div>
        <nav
        ...
        >
          ...
          <div className="icon text-lg flex gap-4  lg:gap-8 lg:my-10">
            ...
            <a
              href="https://www.linkedin.com/in/bruno-gomes-061786255/"
              target="_blank"
            >
